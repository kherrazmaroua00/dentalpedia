  ...
  return (
    <div>
      ...
      <div className="flex justify-between text-sm mb-2">
        <span className="text-gray-600">Théorie <span className="font-bold text-violet-500">{value}%</span></span>
        <span className="text-gray-600">Clinique <span className="font-bold text-emerald-500">{100 - value}%</span></span>
      </div>
