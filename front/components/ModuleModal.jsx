    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4 py-8 overflow-y-auto">
      <div className="bg-white rounded-2xl w-full max-w-2xl p-8 relative my-auto">
        ...
        <div className="border border-violet-100 rounded-2xl p-5 mb-5">
          <h3 className="flex items-center gap-2 text-sm font-bold text-violet-700 mb-4">
        ...
        <div className="border border-violet-100 rounded-2xl p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={addVideoRow}
              className="flex items-center gap-1.5 text-xs font-medium bg-violet-700 hover:bg-violet-800 text-white px-3 py-2 rounded-lg transition"
            >
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-700 hover:bg-violet-800 disabled:opacity-60 text-white font-medium transition"
          >
